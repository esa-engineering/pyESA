...
if csv_path:
	...
	if shift:
		...
		project_point_angle = project_position.Angle
	else:
	...
	wd_description = [l_safe_str(wd) for wd in warnings_data[0]]
	...
	wrvt_levels = []
	for wrn in warnings:
		wrvt_description.append(l_safe_str(wrn.GetDescriptionText()))
	...
	if warnings:
		for wd, ws, we, wl in zip(wrvt_description, wrvt_score, wrvt_elements, wrvt_levels):
			row_06_01.append((chapter_06, 'Warnings', wd, '',
